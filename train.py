...
import os
import pickle
from utils import Flickr_eval, to_var
...
def main(args):
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        for i, (images, captions, lengths, det_features, _, _) in enumerate(data_loader):
            ...
            packed_scores = adaptive(images, captions, lengths, det_features)
        ...
        cider = Flickr_eval(adaptive, args, epoch)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_size', type=int, default=20)  # on cluster setup, 30 each x 4
